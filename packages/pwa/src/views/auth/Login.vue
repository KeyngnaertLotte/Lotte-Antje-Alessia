      ...
      <div class="mt-6 w-full">
        <div class="w-full flex justify-center">
          <input
            ...
            name="email"
            id="email"
            class="block w-9/10 border-b-2 border-custom-darkGreen p-1 text-xl focus:outline-none focus:rounded-lg focus-visible:border-custom-orange focus-visible:ring-2 focus-visible:ring-custom-brown focus-visible:ring-2"
        ...
        <div class="w-full flex flex-col justify-center items-center m-t-4">
          ...
          <RouterLink
            ...
            class="w-9/10 mt-1 inline-block rounded text-custom-darkGreen focus:outline-none focus-visible:border-custom-orange focus-visible:ring-2 focus-visible:ring-custom-brown focus-visible:ring-2"
          >
            Passwoord vergeten
          </RouterLink>
        </div>
