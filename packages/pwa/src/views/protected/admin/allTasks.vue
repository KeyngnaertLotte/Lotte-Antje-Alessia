<template>
  <div class="col-span-2 rounded-lg bg-white row-span-22 m-5 p-6">
    <div class="w-full flex flex-row justify-between mb-4">
      ...
      <button
        class="flex items-start justify-start bg-custom-orange rounded-lg hover:bg-custom-brown focus:outline-none focus-visible:border-custom-orange focus-visible:bg-custom-brown focus-visible:ring-2 focus-visible:ring-custom-orange"
        @click="handleOpenAddTask"
      >
        <Plus class="w-10 h-10 stroke-white" />
      </button>
    </div>
