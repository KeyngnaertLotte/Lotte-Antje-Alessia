<template>
    <div class="col-span-2 row-start-8 row-span-17 bg-white rounded-xl m-4 grid grid-rows-17">
        ...
        <div class="overflow-y-auto row-start-3 row-span-16">
            <div v-for="(item, index) in AgendaItems" :key="index" :class="['flex', 'flex-col', 'justify-center', 'items-center', 'p-2', 'm-4', 'mt-0', 'rounded-lg', `bg-[#94C9A9]`]">
                <p class="font-bold text-white text-2xl font-body self-start">{{ item.taak }}</p>
                <p class="text-white text-lg font-body self-start"> podium: {{ item.podium }}</p>
  ...
  <script setup lang="ts">
    ...
    const AgendaItems = ref([
        {taak: "Opzetten", podium: "Antje", tijd: "18:00 - 19:00"},
        {taak: "Soundcheck", podium: "Antje", tijd: "19:00 - 19:30"},
        {taak: "Optreden", podium: "Antje", tijd: "20:00 - 21:30"},
        {taak: "Afbreken", podium: "Antje", tijd: "21:30 - 21:45"},
        {taak: "Opzetten", podium: "Antje", tijd: "18:00 - 19:00"},
        {taak: "Soundcheck", podium: "Antje", tijd: "19:00 - 19:30"},
        {taak: "Optreden", podium: "Antje", tijd: "20:00 - 21:30"},
        {taak: "Afbreken", podium: "Antje", tijd: "21:30 - 21:45"},
