<template>
  ...
  >
    ...
    >
      <button
        @click="closeModal"
        class="absolute top-[-1rem] right-[-0.5rem] flex justify-end bg-[#D5573B] rounded-lg h-12 w-12 flex justify-center items-center"
      >
      ...
      <p class="font-pop text-lg text-justify">
        {{
          $t(
...
//     top: "Meest gekende liedjes: Bones, Believer, Demons en Enemy"
//     },
